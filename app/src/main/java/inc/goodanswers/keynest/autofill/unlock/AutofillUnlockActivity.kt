package inc.goodanswers.keynest.autofill.unlock
...
import inc.goodanswers.keynest.autofill.builder.DatasetPresentationFactory
import inc.goodanswers.keynest.autofill.builder.FillResponseBuilder
import inc.goodanswers.keynest.di.ServiceLocator
import inc.goodanswers.keynest.domain.model.CredentialId
import inc.goodanswers.keynest.util.SafeLogger
...
class AutofillUnlockActivity : AppCompatActivity() {
    ...
    private fun runUnlockFlow(
        ...
        lifecycleScope.launch {
            ...
            val authResult = authenticator.authenticate(
                title = getString(inc.goodanswers.keynest.R.string.biometric_prompt_title),
                subtitle = getString(inc.goodanswers.keynest.R.string.biometric_prompt_subtitle),
            )
            when (authResult) {
    ...
    companion object {
        private const val EXTRA_CREDENTIAL_ID = "inc.goodanswers.keynest.extra.CREDENTIAL_ID"
        private const val EXTRA_USERNAME_AUTOFILL_ID = "inc.goodanswers.keynest.extra.USERNAME_AUTOFILL_ID"
        private const val EXTRA_PASSWORD_AUTOFILL_ID = "inc.goodanswers.keynest.extra.PASSWORD_AUTOFILL_ID"
