package inc.goodanswers.keynest.domain.repository
...
import inc.goodanswers.keynest.domain.model.VaultMetadata
 ...
 * ([inc.goodanswers.keynest.data.repository.CredentialRepositoryImpl]) and maps
