 ...
 *   gated by the app-level BiometricPrompt in [inc.goodanswers.keynest.auth.
 *   BiometricAuthenticator] / [inc.goodanswers.keynest.autofill.unlock.
...
open class KeystoreKeyProvider(
     ...
     * [inc.goodanswers.keynest.domain.model.ClearVaultFailure.KeystoreAlias].
     */
    open fun deleteKey() {
        val keyStore = KeyStore.getInstance(keystoreProvider).apply { load(null) }
