...
import inc.goodanswers.keynest.databinding.SettingsActivityBinding
import inc.goodanswers.keynest.di.ServiceLocator
import inc.goodanswers.keynest.domain.model.AutofillStatus
import inc.goodanswers.keynest.domain.model.DeviceLockStatus
import inc.goodanswers.keynest.ui.danger.DangerZoneActivity
import inc.goodanswers.keynest.ui.oss.OssLicensesActivity
import inc.goodanswers.keynest.util.AdvancedDetailsFormatter
import inc.goodanswers.keynest.util.SystemSettingsIntents
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun bindVault(
        metadata: inc.goodanswers.keynest.domain.model.VaultMetadata,
        storageBytes: Long,
    ) {
