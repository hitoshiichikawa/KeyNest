 ...
 *   gated by the app-level BiometricPrompt in [io.github.hitoshiichikawa.keynest.auth.
 *   BiometricAuthenticator] / [io.github.hitoshiichikawa.keynest.autofill.unlock.
...
open class KeystoreKeyProvider(
     ...
     * [io.github.hitoshiichikawa.keynest.domain.model.ClearVaultFailure.KeystoreAlias].
     */
    open fun deleteKey() {
        val keyStore = KeyStore.getInstance(keystoreProvider).apply { load(null) }
