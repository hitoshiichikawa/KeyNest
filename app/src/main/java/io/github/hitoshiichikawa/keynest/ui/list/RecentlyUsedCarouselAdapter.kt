...
import io.github.hitoshiichikawa.keynest.databinding.CredentialListRecentItemBinding
    ...
    class ViewHolder(
        ...
        fun bind(item: Credential, onClick: (Credential) -> Unit, iconLoader: IconLoader) {
            ...
            binding.cardRecent.contentDescription = binding.root.context.getString(
                io.github.hitoshiichikawa.keynest.R.string.credential_list_recent_card_a11y,
                item.label,
            )
