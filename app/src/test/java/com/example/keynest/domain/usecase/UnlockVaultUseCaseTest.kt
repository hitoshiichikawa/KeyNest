 ...
 * the instrumented [com.example.keynest.security.AesGcmCipherTest].
 */
class UnlockVaultUseCaseTest {
    ...
    fun invoke_returnsDecryptFailure_whenCipherThrows() = runTest {
        ...
        val throwingCipher = object : com.example.keynest.security.AesGcmCipher(stubProvider()) {
            override fun decrypt(blob: com.example.keynest.security.EncryptedBlob): ByteArray =
    ...
    private fun stubProvider() = object : com.example.keynest.security.KeystoreKeyProvider() {
