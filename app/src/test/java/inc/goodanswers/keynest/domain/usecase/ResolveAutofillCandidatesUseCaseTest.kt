...
class ResolveAutofillCandidatesUseCaseTest {
    ...
    fun invoke_swallowsRepositoryExceptions_returningEmpty() = runTest {
        ...
        val throwingRepo = object : inc.goodanswers.keynest.domain.repository.CredentialRepository {
            ...
            override fun observeAll() = kotlinx.coroutines.flow.flowOf(emptyList<inc.goodanswers.keynest.domain.model.Credential>())
            ...
            override fun observeBySort(
                order: inc.goodanswers.keynest.domain.model.CredentialSortOrder,
            ) = kotlinx.coroutines.flow.flowOf(
                emptyList<inc.goodanswers.keynest.domain.model.Credential>(),
            )
            ...
            override fun observeMetadata() = kotlinx.coroutines.flow.flowOf(
                inc.goodanswers.keynest.domain.model.VaultMetadata(count = 0, latestUpdatedAt = null),
            )
