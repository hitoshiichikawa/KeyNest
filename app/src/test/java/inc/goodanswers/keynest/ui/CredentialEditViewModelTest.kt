package inc.goodanswers.keynest.ui
...
import inc.goodanswers.keynest.domain.usecase.StubAesGcmCipher
import inc.goodanswers.keynest.domain.usecase.UpdateCredentialUseCase
import inc.goodanswers.keynest.ui.edit.CredentialEditViewModel
...
class CredentialEditViewModelTest {
    ...
    fun save_inEditMode_dispatchesToUpdateUseCase_andUpdatesSignature() = runTest(testDispatcher) {
        ...
        repo.put(
            inc.goodanswers.keynest.domain.model.EncryptedCredentialRecord(
                id = CredentialId(0L),
        ...
        val newHash = inc.goodanswers.keynest.domain.model.SigningHash.ofSha256("NEW".toByteArray())
