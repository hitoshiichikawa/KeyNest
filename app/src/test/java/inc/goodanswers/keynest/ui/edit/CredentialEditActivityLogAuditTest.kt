 ...
 * crash analytics. Only [inc.goodanswers.keynest.util.SafeLogger.previewHex]
...
class CredentialEditActivityLogAuditTest {
    ...
    fun activitySource_doesNotLogFullSignatureHex() {
        ...
        val source = File("src/main/java/com/example/keynest/ui/edit/CredentialEditActivity.kt")
