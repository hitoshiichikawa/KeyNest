...
class ResolveAutofillCandidatesUseCaseTest {
    ...
    fun invoke_swallowsRepositoryExceptions_returningEmpty() = runTest {
        ...
        val throwingRepo = object : io.github.hitoshiichikawa.keynest.domain.repository.CredentialRepository {
            ...
            override fun observeAll() = kotlinx.coroutines.flow.flowOf(emptyList<io.github.hitoshiichikawa.keynest.domain.model.Credential>())
            ...
            override fun observeBySort(
                order: io.github.hitoshiichikawa.keynest.domain.model.CredentialSortOrder,
            ) = kotlinx.coroutines.flow.flowOf(
                emptyList<io.github.hitoshiichikawa.keynest.domain.model.Credential>(),
            )
            ...
            override fun observeMetadata() = kotlinx.coroutines.flow.flowOf(
                io.github.hitoshiichikawa.keynest.domain.model.VaultMetadata(count = 0, latestUpdatedAt = null),
            )
